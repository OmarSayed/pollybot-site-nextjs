  ...
  return (
    <div
      className={`relative p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ${
        planData.cardBg
      } ${planData.popular ? "ring-2 ring-pink-500 scale-105" : ""}`}
    >
      {planData.popular && (
      ...
      <Button
        className={`w-full ${planData.buttonColor} ${
          isComingSoon
            ? "opacity-50 cursor-not-allowed mb-8"
            : "cursor-pointer mb-8"
        }`}
...
const PricingSection = () => {
  ...
  const plansData: PlanData[] = [
    ...
    },
    {
      ...
      cardBg:
        "bg-gradient-to-br from-pink-50/80 to-violet-50/80 dark:from-pink-950/20 dark:to-violet-950/20 border-pink-200 dark:border-pink-800",
      tabColor:
        "data-[state=active]:bg-gradient-to-r data-[state=active]:from-pink-500 data-[state=active]:to-violet-500 data-[state=active]:text-white",
    },
    {
      name: "Falcon",
      monthlyPrice: "$250",
  ...
  const currentPlan =
    plansData.find((plan) => plan.name === activePlan) || plansData[2];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Choose the perfect plan for your community. Start with our 7-day
            free trial.
          </p>
        ...
        <div className="text-center mt-12">
          <p className="text-base text-muted-foreground mb-4">
            All plans include a 7-day free trial. After trial, use your own
            OpenAI API key.
          </p>
          <Button
